...
export default function Reverber({
  ...
  const changeReverbsMix = (e: React.FormEvent<HTMLInputElement>): void => {
  ...
  const changeReverbsDecay = (e: React.FormEvent<HTMLInputElement>): void => {
    if (channelType === "track") {
